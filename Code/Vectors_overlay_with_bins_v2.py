...
## SELECCIÓN DE VIDEO ##
########################
#Variable para seleccionar el video a procesar. Cambia el valor a la clave del video que quieras procesar (ej: "video1_clip1", "video2_clip3", etc.)
SELECTED_VIDEO= "video1_clip3"

#Configuración del video seleccionado
