...
EXCEL_FILE  = r"data/Sensor/Sensor_DataFiles/Global.xlsx"
SHEET_NAME  = 0
OUTPUT_DIR  = r"outputs/graphical_results"
DATA_ROOT   = r"data/Asturias_analized"

os.makedirs(OUTPUT_DIR, exist_ok=True)

# Y2K epoch ranges for each clip and complete session
VIDEO_CLIPS = {
...
# Per-clip temporal offset (seconds) applied to the start epoch
CLIP_DELAYS = {
    "v1_complete": 36, "v1_clip1": 36,
    "v2_complete": 60, "v2_clip1": 60,
    "v3_complete": 0,  "v3_clip1": 0, "v3_clip3": 60,
    "v4_complete": 11, "v4_clip1": 11,
    "v4_clip2":    0,  "v4_clip3": 0,
}

# Which sub-clips belong to each complete session (used for thumbnail extraction)
...
# Classification CSV paths (output of Classification.py / Classification_automatic.py)
CLASSIFICATION_FILES = {
    "v1_clip1": f"{DATA_ROOT}/Video 1 (30_07_2025_10AM)/DJI_20250730102351_0001_D/DJI_20250730102351_0001_D_detected_cropped_classified.csv",
    "v1_clip2": f"{DATA_ROOT}/Video 1 (30_07_2025_10AM)/DJI_20250730102351_0002_D/DJI_20250730102740_0002_D_detected_cropped_classified.csv",
    "v1_clip3": f"{DATA_ROOT}/Video 1 (30_07_2025_10AM)/DJI_20250730102351_0003_D/DJI_20250730103129_0003_D_detected_cropped_classified.csv",
    "v1_clip4": f"{DATA_ROOT}/Video 1 (30_07_2025_10AM)/DJI_20250730102351_0004_D/DJI_20250730103517_0004_D_detected_cropped_classified.csv",
    "v2_clip1": f"{DATA_ROOT}/Video 2 (30_07_2025_11AM)/DJI_20250730110740_0003_D/DJI_20250730110740_0003_D_detected_cropped_classified.csv",
    "v2_clip2": f"{DATA_ROOT}/Video 2 (30_07_2025_11AM)/DJI_20250730111129_0004_D/DJI_20250730111129_0004_D_detected_cropped_classified.csv",
    "v2_clip3": f"{DATA_ROOT}/Video 2 (30_07_2025_11AM)/DJI_20250730111517_0005_D/DJI_20250730111517_0005_D_detected_cropped_classified.csv",
    "v2_clip4": f"{DATA_ROOT}/Video 2 (30_07_2025_11AM)/DJI_20250730111906_0006_D/DJI_20250730111906_0006_D_detected_cropped_classified.csv",
    "v2_clip5": f"{DATA_ROOT}/Video 2 (30_07_2025_11AM)/DJI_20250730112255_0007_D/DJI_20250730112255_0007_D_detected_cropped_classified.csv",
    "v3_clip1": f"{DATA_ROOT}/Video 3 (30_07_2025_11_30AM)/DJI_20250730113843_0001_D/DJI_20250730113843_0001_D_detected_cropped_classified.csv",
    "v3_clip2": f"{DATA_ROOT}/Video 3 (30_07_2025_11_30AM)/DJI_20250730114231_0002_D/DJI_20250730114231_0002_D_detected_cropped_classified.csv",
    "v3_clip3": f"{DATA_ROOT}/Video 3 (30_07_2025_11_30AM)/DJI_20250730114620_0003_D/DJI_20250730114620_0003_D_detected_cropped_classified.csv",
    "v3_clip4": f"{DATA_ROOT}/Video 3 (30_07_2025_11_30AM)/DJI_20250730115009_0004_D/DJI_20250730115009_0004_D_detected_cropped_classified.csv",
    "v3_clip5": f"{DATA_ROOT}/Video 3 (30_07_2025_11_30AM)/DJI_20250730115358_0005_D/DJI_20250730115358_0005_D_detected_cropped_classified.csv",
    "v5_clip3": f"{DATA_ROOT}/Video 5 (20250730_BUCKET#019_drone-camera_DJI_202508041055_005)/DJI_20250804110553_0003_D/DJI_20250804110553_0003_D_detected_cropped.MP4",
    "v5_clip4": f"{DATA_ROOT}/Video 5 (20250730_BUCKET#019_drone-camera_DJI_202508041055_005)/DJI_20250804110942_0004_D/DJI_20250804110942_0004_D_detected_cropped.MP4",
    "v5_clip5": f"{DATA_ROOT}/Video 5 (20250730_BUCKET#019_drone-camera_DJI_202508041055_005)/DJI_20250804111331_0005_D/DJI_20250804111331_0005_D_detected_cropped.MP4",
    "v6_clip1": f"{DATA_ROOT}/Video 6 (20250730_BUCKET#007_drone-camera_DJI_202508041123_006)/DJI_20250804112638_0001_D/DJI_20250804112638_0001_D_detected_cropped.MP4",
    "v6_clip2": f"{DATA_ROOT}/Video 6 (20250730_BUCKET#007_drone-camera_DJI_202508041123_006)/DJI_20250804113027_0002_D/DJI_20250804113027_0002_D_detected_cropped.MP4",
    "v6_clip3": f"{DATA_ROOT}/Video 6 (20250730_BUCKET#007_drone-camera_DJI_202508041123_006)/DJI_20250804113416_0003_D/DJI_20250804113416_0003_D_detected_cropped.MP4",
    "v6_clip4": f"{DATA_ROOT}/Video 6 (20250730_BUCKET#007_drone-camera_DJI_202508041123_006)/DJI_20250804113805_0004_D/DJI_20250804113805_0004_D_detected_cropped.MP4",
    "v6_clip5": f"{DATA_ROOT}/Video 6 (20250730_BUCKET#007_drone-camera_DJI_202508041123_006)/DJI_20250804114153_0005_D/DJI_20250804114153_0005_D_detected_cropped.MP4",
    "v7_clip1": f"{DATA_ROOT}/Video 7 (20250730_BUCKET#008_drone-camera_DJI_202508041150_007)/DJI_20250804115309_0001_D/DJI_20250804115309_0001_D_detected_cropped.MP4",
    "v7_clip2": f"{DATA_ROOT}/Video 7 (20250730_BUCKET#008_drone-camera_DJI_202508041150_007)/DJI_20250804115658_0002_D/DJI_20250804115658_0002_D_detected_cropped.MP4",
    "v7_clip3": f"{DATA_ROOT}/Video 7 (20250730_BUCKET#008_drone-camera_DJI_202508041150_007)/DJI_20250804120047_0003_D/DJI_20250804120047_0003_D_detected_cropped.MP4",
    "v7_clip4": f"{DATA_ROOT}/Video 7 (20250730_BUCKET#008_drone-camera_DJI_202508041150_007)/DJI_20250804120436_0004_D/DJI_20250804120436_0004_D_detected_cropped.MP4",
    "v7_clip5": f"{DATA_ROOT}/Video 7 (20250730_BUCKET#008_drone-camera_DJI_202508041150_007)/DJI_20250804120824_0005_D/DJI_20250804120824_0005_D_detected_cropped.MP4",
    "v8_clip1": f"{DATA_ROOT}/Video 8 (20250730_BUCKET#009_drone-camera_DJI_202508041221_008)/DJI_20250804122439_0001_D/DJI_20250804122439_0001_D_detected_cropped.MP4",
    "v8_clip2": f"{DATA_ROOT}/Video 8 (20250730_BUCKET#009_drone-camera_DJI_202508041221_008)/DJI_20250804122828_0002_D/DJI_20250804122828_0002_D_detected_cropped.MP4",
    "v8_clip3": f"{DATA_ROOT}/Video 8 (20250730_BUCKET#009_drone-camera_DJI_202508041221_008)/DJI_20250804123217_0003_D/DJI_20250804123217_0003_D_detected_cropped.MP4",
    "v8_clip4": f"{DATA_ROOT}/Video 8 (20250730_BUCKET#009_drone-camera_DJI_202508041221_008)/DJI_20250804123217_0003_D/DJI_20250804123217_0003_D_detected_cropped.MP4",
}
...
def find_subclip_for_epoch(clip_name, node_epoch_y2k):
    """Return (video_path, clip_start_epoch) for the sub-clip that contains this epoch."""
...
def extract_frame_at_epoch(video_path, node_epoch_y2k, clip_start_epoch_y2k,
    ...
    if offset_seconds < 0:
        print(f"  [WARNING] Negative time offset for {video_path}")
        return None
...
def plot_thumbnail_at_node(ax, img_array, lon, lat, zoom=0.5, offset_points=(0, 70)):
    ...
    ax.plot([node_data[0], thumb_data[0]], [node_data[1], thumb_data[1]],
            color='black', lw=0.8, zorder=4, solid_capstyle='round')

    imagebox = OffsetImage(img_array, zoom=zoom)
    imagebox.image.axes = ax
    ab = AnnotationBbox(
        imagebox, xy=thumb_data, xycoords='data',
        xybox=(0, 0), boxcoords='offset points', pad=0.3,
        bboxprops=dict(boxstyle='round,pad=0.2', facecolor='white',
                       edgecolor='black', linewidth=0.8, alpha=0.9),
        arrowprops=None, zorder=7,
    )
    ax.add_artist(ab)
...
def _connector_crosses_existing(node_disp, thumb_center, existing_connectors):
    return any(
        _segments_intersect(node_disp, thumb_center, en, et)
...
def build_density_map(ax, fig, lon_d, lat_d, valid_mask,
    ...
    """Build a pixel-level occupancy grid to avoid thumbnail overlaps."""
    ...
    if len(valid_lons) > 1:
        ...
        for i in range(len(pts) - 1):
            mark_line(pts[i, 0], pts[i, 1], pts[i+1, 0], pts[i+1, 1], thickness=10)
...
def find_best_offset(ax, fig, lon, lat, existing_boxes, thumb_zoom,
    ...
    """Find the least-overlapping position offset for a thumbnail."""
    direction_groups = [
    ...
    for offset in ordered:
        ...
        if (cx - hw < ax_bbox.x0 + MARGIN or cx + hw > ax_bbox.x1 - MARGIN or
                cy - hh < ax_bbox.y0 + MARGIN or cy + hh > ax_bbox.y1 - MARGIN):
            bounds_penalty = 1e9
        else:
            bounds_penalty = 0
        ...
        cross_count   = sum(
            ...
            if _segments_intersect(node_disp, (cx, cy), en, et)
        )
        score = bounds_penalty + thumb_overlap + occ_score + dist_penalty + cross_count * CROSS_PENALTY
...
def draw_vector_key(fig, ax, corner, ref_speed,
    ...
    inset.annotate("", xy=(wind_end_x, WIND_Y), xytext=(START_X, WIND_Y),
                   arrowprops=dict(arrowstyle="-|>", color=WIND_COLOR, lw=1.8, mutation_scale=10), zorder=5)
    inset.text(START_X + (wind_end_x - START_X) / 2, WIND_Y + LABEL_OFF,
               f"Wind  {ref_speed:.0f} m/s", ha='center', va='center',
               fontsize=6.5, color=WIND_COLOR, fontweight='bold', clip_on=False)

    inset.annotate("", xy=(current_end_x, CURR_Y), xytext=(START_X, CURR_Y),
                   arrowprops=dict(arrowstyle="-|>", color=CURRENT_COLOR, lw=1.8, mutation_scale=10), zorder=5)
    inset.text(START_X + (current_end_x - START_X) / 2, CURR_Y - LABEL_OFF,
               f"Current  {ref_speed:.0f} m/s", ha='center', va='center',
               fontsize=6.5, color=CURRENT_COLOR, fontweight='bold', clip_on=False)

    inset.set_zorder(20)

    fig_w_px, fig_h_px = fig.get_size_inches() * fig.dpi
    return inset, (x0 * fig_w_px, y0 * fig_h_px, panel_w * fig_w_px, panel_h * fig_h_px)
...
def clean_numeric_series(series):
    if pd.api.types.is_numeric_dtype(series):
        return series
    s = series.astype(str).str.replace(',', '.').str.replace(r'[^\d\.\-]', '', regex=True)
...
def process_clip(clip_name, START_EPOCH, END_EPOCH):
    ...
    # Load posture classification labels if available
    ...
    if class_file and os.path.exists(class_file):
        try:
            ...
            if not _df.empty and 'class' in _df.columns:
                ...
                print(f"  [WARNING] Missing 'class' column in: {class_file}")
    ...
    for i in range(len(node_times) - 1):
        seg = df.loc[node_times[i]:node_times[i + 1], "drone_speed"].dropna()
        seg = seg[seg <= 10]
        segment_speeds.append(seg.mean() if not seg.empty else np.nan)

    thumb_zoom = 0.6 if num_nodes <= 8 else (0.45 if num_nodes <= 14 else 0.3)
    print(f"  Thumbnail zoom: {thumb_zoom}")
    ...
    for i in range(len(segment_speeds)):
        if not valid_mask[i] or not valid_mask[min(i + 1, len(valid_mask) - 1)]:
            continue
        ...
        if angle > 90:
            ...
            angle += 180
        ax.text(mid_lon, mid_lat, f"{segment_speeds[i]:.2f} m/s",
    ...
    ax.set_title(
        f"Drone trajectory and wind, current and drone speed vectors from "
        f"{t0_cest.strftime('%Y-%m-%d %H:%M:%S')} to {t1_cest.strftime('%Y-%m-%d %H:%M:%S')} CEST\n"
        f"(Vectors each {node_step} s, drone speed limited to {max_drone_speed} m/s)",
        fontsize=14, pad=2,
    )

    legend_loc   = find_empty_corner(ax, lon_d, lat_d, valid_mask)
    north_corner = find_empty_corner(ax, lon_d, lat_d, valid_mask, exclude={legend_loc})
    used_two     = {legend_loc, north_corner}
    scale_corner = next((c for c in ['lower left', 'lower right'] if c not in used_two), 'lower left')
    all_corners  = {'upper right', 'upper left', 'lower right', 'lower left'}
    key_corner   = next((c for c in all_corners if c not in {legend_loc, north_corner, scale_corner}), 'lower right')

    anchor_map = {
        'upper right': (0.98, 0.98), 'upper left':  (0.02, 0.98),
        'lower right': (0.98, 0.24), 'lower left':  (0.02, 0.24),
    }
    legend_handles = [
        Line2D([0], [0], color='gray', lw=2, linestyle='-', alpha=0.5, label='Trajectory'),
    ...
    legend = ax.legend(handles=legend_handles, loc=legend_loc,
                       bbox_to_anchor=anchor_map[legend_loc], frameon=True,
    ...
    ax.annotate('N', xy=(nx_tip, ny_tip), xytext=(nx_txt, ny_txt),
    ...
    occupancy = build_density_map(ax, fig, lon_d, lat_d, valid_mask,
                                  uw_scaled, vw_scaled, uc_scaled, vc_scaled)
    ...
    occupancy[max(0, ky0_occ):min(H_occ, ky1_occ),
              max(0, int(kx0)):min(W_occ, int(kx0 + kw))] = True
    ...
    try:
        ...
        occupancy[max(0, leg_r0 - PAD):min(H_occ, leg_r1 + PAD),
                  max(0, int(legend_bbox.x0) - PAD):min(W_occ, int(legend_bbox.x1) + PAD)] = True
    except Exception:
        pass
    ...
    for idx in range(len(lon_d)):
        ...
        best_offset = find_best_offset(
            ...
            existing_connectors, node_index=valid_node_count,
        )
